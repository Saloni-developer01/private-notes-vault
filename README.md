...
## 🚀 Live Demo
[Click here to view the Live Site](https://private-notes-vault.netlify.app/) 
...
- **Note Management**: Create, view, edit, and delete notes in real-time.
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/Saloni-developer01/private-notes-vault.git
